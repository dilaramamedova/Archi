...
class BannerResource extends Resource
{
        ...
        return $form->schema([
            Section::make()->schema([
                Forms\Components\Select::make('position')
                    ->label('Mövqe')
                    ->options([
                        'hero_main' => 'Hero — Əsas banner',
                        'hero_promo' => 'Hero — Promo karusel',
                        'hero_role' => 'Hero — Rol slider',
                    ])
                    ->required(),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                Tables\Columns\ImageColumn::make('image')->label('Şəkil')->width(80)->height(50),
                Tables\Columns\TextColumn::make('title')->label('Başlıq')->limit(40),
                Tables\Columns\TextColumn::make('position')->label('Mövqe')->badge(),
