...
class AboutValueResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Dəyərlər';
    protected static ?string $modelLabel = 'Dəyər';
    protected static ?string $pluralModelLabel = 'Dəyərlər';
    ...
    public static function form(Schema $form): Schema
    {
        return $form->schema([
            Section::make()->schema([
                ...
                Forms\Components\Textarea::make('description')->label('Açıqlama')->rows(3)->required()->translatable(),
