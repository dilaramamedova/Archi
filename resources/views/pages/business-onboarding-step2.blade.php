<x-layout page="business-onboarding-step2" :title="t('business-onboarding-step2.title')" bodyClass="[word-break:break-word]">
...
<div class="mx-auto flex max-w-[1440px] flex-col items-start gap-5 px-7 pt-8">
  <a class="shrink-0 whitespace-pre text-sm font-medium leading-[normal] text-black/50" href="{{ route('business.profile') }}">{{ t('business-onboarding-step2.back') }}</a>
  <h1 class="shrink-0 whitespace-nowrap text-[32px] font-bold leading-[normal] tracking-[-0.5px] text-ink">{{ t('business-onboarding-step2.heading') }}</h1>
</div>
...
<div class="mx-auto flex max-w-[1440px] items-start gap-8 px-7 pt-8 pb-12 max-[1200px]:flex-col">
  <div class="flex w-full max-w-[880px] flex-col items-start gap-2.5 max-[1200px]:max-w-none">
    ...
    <div class="flex w-full items-center justify-between border border-black/10 bg-white p-[19px] max-[640px]:flex-col max-[640px]:items-start max-[640px]:gap-3">
      <div class="flex shrink-0 items-center gap-2">
        ...
        <p class="whitespace-nowrap text-sm font-medium leading-[normal] text-ink">{{ t('business-onboarding-step2.steps.basic') }}</p>
      </div>
      ...
      <div class="flex shrink-0 items-center gap-2">
        ...
        <p class="whitespace-nowrap text-sm font-bold leading-[normal] text-ink" aria-current="step">{{ t('business-onboarding-step2.steps.contact') }}</p>
      </div>
      <div class="h-0.5 w-5 shrink-0 bg-[#e0e3e8]"></div>
      <div class="flex shrink-0 items-center gap-2">
        ...
        <p class="whitespace-nowrap text-[13px] font-medium leading-[normal] text-ink">{{ t('business-onboarding-step2.steps.product') }}</p>
      </div>
    </div>
    ...
    <div class="flex w-full flex-col items-start gap-5 overflow-hidden rounded-ds border border-black/10 bg-white px-[31px] py-[27px]">
      ...
      <div class="flex w-full items-start gap-4 overflow-hidden bg-white max-[640px]:flex-col">
        <x-ui.field variant="b2b" :label="t('business-onboarding-step2.form.contact_person_label')" for="onb2-contact-person"
          ...
          <x-ui.input variant="b2b" id="onb2-contact-person" name="contact_person" autocomplete="name"
                      ...
                      :placeholder="t('business-onboarding-step2.form.contact_person_placeholder')" />
        </x-ui.field>
        <x-ui.field variant="b2b" :label="t('business-onboarding-step2.form.role_label')" for="onb2-role"
                    class="relative min-w-px flex-[1_0_0] items-start gap-1.5 max-[640px]:w-full">
          <x-ui.input variant="b2b" id="onb2-role" name="role" autocomplete="organization-title"
                      class="rounded-none border-black/10 px-[13px] py-[11px] placeholder:text-[#808085]"
                      :placeholder="t('business-onboarding-step2.form.role_placeholder')" />
        </x-ui.field>
      </div>

      {{-- frow — 14px gutter (1105:21075) --}}
      <div class="flex w-full items-start gap-3.5 max-[640px]:flex-col">
        <x-ui.field variant="b2b" :label="t('business-onboarding-step2.form.phone_label')" for="onb2-phone"
                    class="relative min-w-px flex-[1_0_0] items-start gap-1.5 max-[640px]:w-full">
          <x-ui.input variant="b2b" id="onb2-phone" type="tel" name="phone" autocomplete="tel"
                      class="rounded-none border-black/10 px-[13px] py-[11px] placeholder:text-[#808085]"
                      :placeholder="t('business-onboarding-step2.form.phone_placeholder')" />
        </x-ui.field>
        <x-ui.field variant="b2b" :label="t('business-onboarding-step2.form.whatsapp_label')" for="onb2-whatsapp"
                    class="relative min-w-px flex-[1_0_0] items-start gap-1.5 max-[640px]:w-full">
          <x-ui.input variant="b2b" id="onb2-whatsapp" type="tel" name="whatsapp"
                      class="rounded-none border-black/10 px-[13px] py-[11px] placeholder:text-[#808085]"
                      :placeholder="t('business-onboarding-step2.form.whatsapp_placeholder')" />
        </x-ui.field>
      </div>

      {{-- frow (1105:21084) --}}
      <div class="flex w-full items-start gap-3.5 max-[640px]:flex-col">
        <x-ui.field variant="b2b" :label="t('business-onboarding-step2.form.telegram_label')" for="onb2-telegram"
                    class="relative min-w-px flex-[1_0_0] items-start gap-1.5 max-[640px]:w-full">
          <x-ui.input variant="b2b" id="onb2-telegram" name="telegram"
                      class="rounded-none border-black/10 px-[13px] py-[11px] placeholder:text-[#808085]"
                      :placeholder="t('business-onboarding-step2.form.telegram_placeholder')" />
        </x-ui.field>
        <x-ui.field variant="b2b" :label="t('business-onboarding-step2.form.email_label')" for="onb2-email"
                    class="relative min-w-px flex-[1_0_0] items-start gap-1.5 max-[640px]:w-full">
          <x-ui.input variant="b2b" id="onb2-email" type="email" name="email" autocomplete="email"
                      class="rounded-none border-black/10 px-[13px] py-[11px] placeholder:text-[#808085]"
                      :placeholder="t('business-onboarding-step2.form.email_placeholder')" />
        </x-ui.field>
      </div>

      {{-- frow (1105:21093) --}}
      <div class="flex w-full items-start gap-3.5 max-[640px]:flex-col">
        <x-ui.field variant="b2b" :label="t('business-onboarding-step2.form.website_label')" for="onb2-website"
                    class="relative min-w-px flex-[1_0_0] items-start gap-1.5 max-[640px]:w-full">
          <x-ui.input variant="b2b" id="onb2-website" type="url" name="website" autocomplete="url"
                      class="rounded-none border-black/10 px-[13px] py-[11px] placeholder:text-[#808085]"
                      :placeholder="t('business-onboarding-step2.form.website_placeholder')" />
        </x-ui.field>
        <x-ui.field variant="b2b" :label="t('business-onboarding-step2.form.hours_label')" for="onb2-hours"
                    class="relative min-w-px flex-[1_0_0] items-start gap-1.5 max-[640px]:w-full">
          <x-ui.input variant="b2b" id="onb2-hours" name="hours"
                      class="rounded-none border-black/10 px-[13px] py-[11px] placeholder:text-[#808085]"
                      :placeholder="t('business-onboarding-step2.form.hours_placeholder')" />
        </x-ui.field>
      </div>

      {{-- Social row — three equal columns (1105:21102) --}}
      <div class="flex w-full items-start gap-3.5 max-[640px]:flex-col">
        <x-ui.field variant="b2b" :label="t('business-onboarding-step2.form.instagram_label')" for="onb2-instagram"
                    class="relative min-w-px flex-[1_0_0] items-start gap-1.5 max-[640px]:w-full">
          <x-ui.input variant="b2b" id="onb2-instagram" name="instagram"
                      class="rounded-none border-black/10 px-[13px] py-[11px] placeholder:text-[#808085]"
                      :placeholder="t('business-onboarding-step2.form.instagram_placeholder')" />
        </x-ui.field>
        <x-ui.field variant="b2b" :label="t('business-onboarding-step2.form.linkedin_label')" for="onb2-linkedin"
                    class="relative min-w-px flex-[1_0_0] items-start gap-1.5 max-[640px]:w-full">
          <x-ui.input variant="b2b" id="onb2-linkedin" name="linkedin"
                      class="rounded-none border-black/10 px-[13px] py-[11px] placeholder:text-[#808085]"
                      :placeholder="t('business-onboarding-step2.form.linkedin_placeholder')" />
        </x-ui.field>
        <x-ui.field variant="b2b" :label="t('business-onboarding-step2.form.facebook_label')" for="onb2-facebook"
                    class="relative min-w-px flex-[1_0_0] items-start gap-1.5 max-[640px]:w-full">
          <x-ui.input variant="b2b" id="onb2-facebook" name="facebook"
                      class="rounded-none border-black/10 px-[13px] py-[11px] placeholder:text-[#808085]"
                      :placeholder="t('business-onboarding-step2.form.facebook_placeholder')" />
        </x-ui.field>
      </div>
      ...
      <div class="flex w-full flex-col items-start gap-2.5" role="group" aria-labelledby="onb2-languages-label">
        <p class="ui-label-b2b" id="onb2-languages-label">{{ t('business-onboarding-step2.form.languages_label') }}</p>
        <div class="flex w-full flex-wrap content-start items-start gap-2.5">
          @foreach (t('business-onboarding-step2.languages') as $key => $label)
      ...
      <div class="flex w-full items-center gap-3 overflow-hidden bg-white">
        <x-ui.button variant="primary" :hover="false" :href="route('business.onboarding.step3')" class="px-7 py-[15px]">
          ...
          <p class="shrink-0 whitespace-pre text-[15px] font-semibold leading-[18px] text-ink">{{ t('business-onboarding-step2.actions.save') }}</p>
        </x-ui.button>
        <a class="shrink-0 whitespace-nowrap text-sm font-medium leading-[normal] text-black/50" href="{{ route('business.profile') }}">{{ t('business-onboarding-step2.actions.later') }}</a>
      </div>
  ...
  <div class="relative flex min-w-px flex-[1_0_0] flex-col items-start gap-4 overflow-hidden bg-white max-[1200px]:w-full max-[1200px]:flex-none">
    <div class="flex w-full shrink-0 flex-col items-start gap-3 overflow-hidden rounded-ds border border-black/10 bg-white p-[19px]">
      <p class="shrink-0 whitespace-nowrap text-sm font-semibold leading-[normal] text-ink">{{ t('business-onboarding-step2.side.progress_title') }}</p>
      ...
      <p class="w-full shrink-0 text-[13px] font-normal leading-[normal] text-black/50">{{ t('business-onboarding-step2.side.progress_note') }}</p>
    </div>
    <div class="flex w-full shrink-0 flex-col items-start gap-2 overflow-hidden rounded-ds border border-yellow-line bg-sel-bg p-[15px] text-[13px]">
      ...
      <p class="shrink-0 whitespace-nowrap font-semibold leading-4 text-ink">{{ t('business-onboarding-step2.side.tip_title') }}</p>
      <p class="w-full shrink-0 font-normal leading-5 text-black/70">{{ t('business-onboarding-step2.side.tip_text') }}</p>
    </div>
  </div>
