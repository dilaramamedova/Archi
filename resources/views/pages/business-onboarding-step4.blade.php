<x-layout page="business-onboarding-step4" :title="t('business-onboarding-step4.title')" bodyClass="text-ink [word-break:break-word]">
...
<div class="mx-auto flex max-w-[1440px] flex-col items-start gap-5 px-7 pt-8">
  <a class="text-sm font-medium leading-[normal] whitespace-pre text-black/50" href="{{ route('business.profile') }}">{{ t('business-onboarding-step4.head.back') }}</a>
  <h1 class="text-[32px] font-bold tracking-[-0.5px] leading-[normal] whitespace-nowrap text-ink">{{ t('business-onboarding-step4.head.title') }}</h1>
</div>
...
<div class="mx-auto flex max-w-[1440px] items-start gap-8 px-7 pt-8 pb-12">
  <div class="flex w-[880px] shrink-0 flex-col items-start gap-2.5">
    ...
    <div class="flex w-[880px] shrink-0 items-center justify-between border border-black/10 bg-white p-5">
      <div class="flex shrink-0 items-center gap-2">
        ...
        <p class="text-sm font-medium leading-[normal] whitespace-nowrap text-ink">{{ t('business-onboarding-step4.stepper.step1') }}</p>
      </div>
      ...
      <div class="flex shrink-0 items-center gap-2">
        ...
        <p class="text-sm font-medium leading-[normal] whitespace-nowrap text-ink">{{ t('business-onboarding-step4.stepper.step2') }}</p>
      </div>
      <div class="h-0.5 w-5 shrink-0 bg-[#e0e3e8]"></div>
      <div class="flex shrink-0 items-center gap-2.5">
        ...
        <p class="text-[13px] font-medium leading-[normal] whitespace-nowrap text-ink">{{ t('business-onboarding-step4.stepper.step3') }}</p>
      </div>
    </div>
    ...
    <x-ui.card class="flex shrink-0 flex-col items-start gap-5 px-8 py-7">
      ...
      <x-ui.field variant="b2b" tag="p" :label="t('business-onboarding-step4.form.images_label')"
        ...
        <div class="flex shrink-0 items-start gap-2.5 overflow-hidden bg-white">
          <div class="flex size-[110px] shrink-0 cursor-pointer flex-col items-center justify-center overflow-hidden rounded-ds border border-dashed border-black/14 bg-gray-soft2 text-center text-xs font-medium text-black/50">
            ...
            <p class="leading-[normal] whitespace-nowrap">{{ t('business-onboarding-step4.form.images_main') }}</p>
          </div>
      ...
      <div class="flex w-full shrink-0 items-start gap-4 bg-white">
        <x-ui.field variant="b2b" :label="t('business-onboarding-step4.form.name_label')"
                    class="min-w-px flex-[1_0_0] items-start overflow-hidden bg-white">
          <x-ui.input variant="b2b" class="py-3" :placeholder="t('business-onboarding-step4.form.name_placeholder')" />
        </x-ui.field>

        {{-- Category combobox — a JS-driven listbox, so it stays page-local (§4.7). --}}
        <x-ui.field variant="b2b" :label="t('business-onboarding-step4.form.category_label')"
          ...
          <div class="group flex w-full shrink-0 cursor-pointer items-center justify-between overflow-hidden rounded-ds border-[1.5px] border-black/14 bg-white px-[15.5px] py-[11.5px] data-[on=true]:border-ink"
            ...
            <p class="text-sm font-normal leading-[normal] whitespace-nowrap text-black/40 data-[filled=true]:text-ink" data-cat-value>{{ t('business-onboarding-step4.form.category_placeholder') }}</p>
          ...
          <div class="absolute top-[calc(100%+3px)] left-0 z-20 flex max-h-[456px] w-max flex-col items-stretch overflow-y-auto rounded-ds border border-black/10 bg-white shadow-[0px_4px_16px_0px_rgba(0,0,0,0.08)] data-[on=false]:hidden"
            ...
            @foreach (t('business-onboarding-step4.categories') as $category)
      ...
      <div class="flex w-full shrink-0 items-start gap-0 overflow-hidden bg-white">
        <x-ui.field variant="b2b" :label="t('business-onboarding-step4.form.brand_label')"
                    class="min-w-px flex-[1_0_0] items-start overflow-hidden bg-white">
          <x-ui.input variant="b2b" class="py-3" :placeholder="t('business-onboarding-step4.form.brand_placeholder')" />
        </x-ui.field>
      </div>

      <div class="flex w-full shrink-0 items-start gap-4 overflow-hidden bg-white">
        <x-ui.field variant="b2b" :label="t('business-onboarding-step4.form.price_label')"
                    class="min-w-px flex-[1_0_0] items-start overflow-hidden bg-white">
          <x-ui.input variant="b2b" class="py-3" :placeholder="t('business-onboarding-step4.form.price_placeholder')" />
        </x-ui.field>

        {{-- Unit picker: a static box in this frame, not a <select>. --}}
        <x-ui.field variant="b2b" :label="t('business-onboarding-step4.form.unit_label')"
                    class="min-w-px flex-[1_0_0] items-start overflow-hidden bg-white">
          <div class="flex w-full shrink-0 items-center justify-between overflow-hidden rounded-ds border border-black/14 bg-white px-4 py-3">
            <p class="text-sm font-normal leading-[normal] whitespace-nowrap text-black/40">{{ t('business-onboarding-step4.form.unit_placeholder') }}</p>
            <img class="size-4 shrink-0" src="/assets/icon-chevron-down.svg" alt="">
          </div>
        </x-ui.field>
      </div>

      <x-ui.field variant="b2b" :label="t('business-onboarding-step4.form.desc_label')"
                  class="w-full shrink-0 items-start overflow-hidden bg-white">
        <x-ui.input variant="b2b" class="py-3" :placeholder="t('business-onboarding-step4.form.desc_placeholder')" />
      </x-ui.field>
      ...
      <div class="flex h-10 w-full shrink-0 items-center gap-2.5 overflow-hidden rounded-ds border border-yellow-line bg-sel-bg px-3.5">
        ...
        <p class="min-w-px flex-[1_0_0] text-[13px] font-normal leading-[normal] text-black/70">{{ t('business-onboarding-step4.form.note') }}</p>
      </div>
      ...
      <div class="flex shrink-0 items-center gap-3 overflow-hidden bg-white">
        ...
        <x-ui.button variant="primary" :hover="false" :href="route('business.profile')" class="h-12 px-7">
          <p class="font-sans text-[15px] font-semibold leading-[normal] whitespace-pre text-ink">{{ t('business-onboarding-step4.form.submit') }}</p>
        </x-ui.button>
        <p class="cursor-pointer text-sm font-medium leading-[normal] whitespace-nowrap text-black/50">{{ t('business-onboarding-step4.form.later') }}</p>
      </div>
    </x-ui.card>
  </div>
  ...
  <div class="flex min-w-px flex-[1_0_0] flex-col items-start gap-4 overflow-hidden bg-white">
    <x-ui.card class="flex shrink-0 flex-col items-start gap-3 overflow-hidden p-5">
      <p class="text-sm font-semibold leading-[normal] whitespace-nowrap text-ink">{{ t('business-onboarding-step4.side.progress_title') }}</p>
      ...
      <p class="w-full text-[13px] font-normal leading-[normal] text-black/50">{{ t('business-onboarding-step4.side.progress_note') }}</p>
    </x-ui.card>
    <div class="flex w-full shrink-0 flex-col items-start gap-2 overflow-hidden rounded-ds border border-yellow-line bg-sel-bg p-4 text-[13px]">
      <p class="font-semibold leading-[normal] whitespace-nowrap text-ink">{{ t('business-onboarding-step4.side.tip_title') }}</p>
      <p class="w-full leading-[1.5] font-normal text-black/70">{{ t('business-onboarding-step4.side.tip_text') }}</p>
    </div>
  </div>
</div>
