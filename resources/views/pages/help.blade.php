<x-layout page="help" :title="__('help.title')">
...
<section class="bg-[#f5f7f9] py-[72px] max-[560px]:py-14">
  <div class="mx-auto flex max-w-[720px] flex-col items-center gap-5 px-7 text-center">
    <h1 class="text-[38px] font-bold text-ink max-[560px]:text-[28px]">{{ __('help.hero_title') }}</h1>
    <div class="relative w-full">
      <input type="text" id="helpSearch" placeholder="{{ __('help.search_placeholder') }}"
    ...
    <p class="text-[13px] text-black/40">{{ __('help.popular_label') }}: <span class="text-ink">{{ __('help.popular_tags') }}</span></p>
  </div>
</section>
...
<section class="wrap py-16 max-[560px]:py-12">
  <div class="inner flex flex-col gap-9">
    <h2 class="text-[26px] font-bold text-ink">{{ __('help.topics_title') }}</h2>
    <div class="grid grid-cols-3 gap-6 max-[900px]:grid-cols-2 max-[560px]:grid-cols-1">
      @foreach ([
        ['icon' => '📦', 'title' => __('help.topic_orders'), 'desc' => __('help.topic_orders_desc')],
        ['icon' => '🚚', 'title' => __('help.topic_delivery'), 'desc' => __('help.topic_delivery_desc')],
        ['icon' => '💰', 'title' => __('help.topic_returns'), 'desc' => __('help.topic_returns_desc')],
        ['icon' => '💳', 'title' => __('help.topic_payment'), 'desc' => __('help.topic_payment_desc')],
        ['icon' => '🔒', 'title' => __('help.topic_security'), 'desc' => __('help.topic_security_desc')],
        ['icon' => '🔧', 'title' => __('help.topic_specialists'), 'desc' => __('help.topic_specialists_desc')],
      ] as $topic)
...
<section class="wrap pb-16 max-[560px]:pb-12">
  <div class="inner flex flex-col gap-9">
    <h2 class="text-[26px] font-bold text-ink">{{ __('help.faq_title') }}</h2>
    <div class="rounded border border-black/10 bg-white" id="helpFaq">
      @foreach ([
        ['q' => __('help.faq1_q'), 'a' => __('help.faq1_a')],
        ['q' => __('help.faq2_q'), 'a' => __('help.faq2_a')],
        ['q' => __('help.faq3_q'), 'a' => __('help.faq3_a')],
        ['q' => __('help.faq4_q'), 'a' => __('help.faq4_a')],
        ['q' => __('help.faq5_q'), 'a' => __('help.faq5_a')],
        ['q' => __('help.faq6_q'), 'a' => __('help.faq6_a')],
      ] as $i => $faq)
  ...
  <div class="inner">
    <div class="flex items-center justify-between gap-6 rounded bg-black/90 px-8 py-8 max-[900px]:flex-col max-[900px]:items-start">
      <div class="flex flex-col gap-1.5">
        <h3 class="text-[22px] font-bold text-white">{{ __('help.contact_title') }}</h3>
        <p class="text-[15px] text-white/60">{{ __('help.contact_subtitle') }}</p>
      </div>
      <div class="flex flex-wrap gap-3">
        <a href="#" class="rounded border border-white/20 bg-white/10 px-5 py-3 text-sm font-semibold text-white transition hover:bg-white/15">{{ __('help.contact_chat') }}</a>
