// Page module for "specialist-cabinet-notifications" — the notification switches and the
...
export default function init() {
  ...
  document.querySelectorAll('.scn-row .ui-toggle').forEach((toggle) =>
  ...
  document.querySelectorAll('.scn-chips .ui-chip').forEach((chip) =>
